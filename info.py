...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003414126808'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003187473140 -1003194562013') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1003849982684')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Channel Is For Index Request 
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1003414126808))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003414126808')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kfcinemas:ujwal1@cluster0.olxb2bz.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "kcfiles")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/All_Movies_request_11')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Kannada_Cineflix')

# True Or False
AI_SPELL_CHECK = bool(environ.get('AI_SPELL_CHECK', True))
PM_SEARCH = bool(environ.get('PM_SEARCH', No))
